...
$(document).ready(function() {
  ...
  */
  ...
  /*
  * It updates the hidden "parent" field with the respective selection
  ...
  */
  ...
  /*
  * If we choose language from the respective menu, it hides every input related
  * language and then displays only the ones associated with the desired one
  */
  ...
  /*
  * It sends a form data asynchronously (ajax)
  */
